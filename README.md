...
```sh
compile 'com.bladejava:blade-mvc:2.0.7-beta1'
```
...
<!-- prettier-ignore -->
| [<img src="https://avatars1.githubusercontent.com/u/3869412?v=4" width="100px;"/><br /><sub><b>Jeroen Engels</b></sub>](https://github.com/jfmengels)<br />[📖](https://github.com/lets-blade/blade/commits?author=jfmengels "Documentation") |
| :---: |
