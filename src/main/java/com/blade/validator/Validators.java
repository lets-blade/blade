...
public final class Validators {
    ...
    static {
        I18N_MAP.put("CN_IS_NULL", "不允许为 NULL");
        I18N_MAP.put("CN_IS_EMPTY", "不允许为空");
        ...
        I18N_MAP.put("CN_NOT_EMAIL", "不是一个合法的邮箱");
        I18N_MAP.put("CN_NOT_URL", "不是一个合法的URL");

        I18N_MAP.put("EN_IS_NULL", "must not be null.");
        I18N_MAP.put("EN_IS_EMPTY", "must not be empty.");
        ...
        I18N_MAP.put("EN_NOT_EMAIL", "must be a email.");
        I18N_MAP.put("EN_NOT_URL", "must be a url.");
    }
    ...
    public static <T> Validation<T> isNull() {
        return isNull(I18N_MAP.get(i18nPrefix + "IS_NULL"));
    }

    public static <T> Validation<T> isNull(String msg) {
        return SimpleValidation.from(Objects::isNull, msg);
    }
    ...
    public static Validation<String> lessThan(int size, String msg) {
        return isEmpty().or(SimpleValidation.from((s) -> s.length() <= size, format(msg, size)));
    }
    ...
    public static Validation<String> contains(String c, String msg) {
        return isEmpty().or(SimpleValidation.from((s) -> s.contains(c), format(msg, c)));
    }
    ...
    public static Validation<String> notEmail() {
        return notEmail(I18N_MAP.get(i18nPrefix + "NOT_EMAIL"));
    }

    public static Validation<String> notEmail(String msg) {
        return isEmpty().or(SimpleValidation.from(PatternKit::isEmail, msg));
    }

    public static Validation<String> notURL() {
        return notURL(I18N_MAP.get(i18nPrefix + "NOT_URL"));
    }

    public static Validation<String> notURL(String msg) {
        return isEmpty().or(SimpleValidation.from(PatternKit::isURL, msg));
    }
