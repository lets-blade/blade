...
import blade.kit.json.parse.JSONParser;
...
public class JSONValue {
     ...
     * 
     * @see blade.kit.json2.JSONObject#writeJSONString(Map, Writer)
     * @see blade.kit.json2.JSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
	 ...
	 * 
	 * @see blade.kit.json2.JSONObject#toJSONString(Map)
	 * @see blade.kit.json2.JSONArray#toJSONString(List)
	 * 
	 * @param value
