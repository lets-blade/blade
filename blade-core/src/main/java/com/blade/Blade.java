...
public class Blade {
     ...
     * @return blade
     */
    public Blade event(@NonNull EventType eventType, @NonNull com.blade.event.EventListener eventListener) {
     ...
     * @return blade
     */
    public Blade on(@NonNull EventType eventType, @NonNull com.blade.event.EventListener eventListener) {
        this.eventManager.addEventListener(eventType, eventListener);
        return this;
    }
