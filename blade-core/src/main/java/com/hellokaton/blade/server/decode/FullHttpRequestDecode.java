 ...
 */
package com.hellokaton.blade.server.decode;
...
/**
 * Decode FullHttpRequest as HttpRequest
 *
 * @author hellokaton
 * 2022/5/3
 */
@Slf4j
public class FullHttpRequestDecode extends SimpleChannelInboundHandler<FullHttpRequest> {
